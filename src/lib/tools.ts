...
export const tools: Tool[] = [
  ...
  {
    slug: "contrast-batch",
    title: "Contrast Ratio Batch Tester",
    shortTitle: "Contrast Batch",
    description: "Test multiple foreground/background color pairs at once. See WCAG AA/AAA pass/fail for all pairs in one table. Export as CSV.",
    metaDescription: "Free batch color contrast checker. Test multiple color pairs simultaneously for WCAG AA and AAA compliance. Export results as CSV. 100% client-side.",
    longDescription: "Add as many foreground/background color pairs as you need and instantly see the contrast ratio, WCAG level (AAA/AA/AA Large/FAIL), and a live preview for each combination. Ideal for design system audits, testing an entire color scale, or reviewing a client's brand palette all at once.",
    icon: Layers,
    category: "check",
    keywords: ["contrast batch", "color contrast multiple", "wcag 1.4.3", "batch contrast checker", "design system contrast"],
    status: "live",
    whyItMatters: "Testing colors one-by-one is slow and error-prone. Design systems can have dozens of color combinations. A batch tester lets you audit your entire palette in one pass, making it easy to catch failures before they reach production.",
    howToUse: [
      { step: "Review the preloaded pairs", description: "Six common color combinations are loaded by default. Edit any pair by changing the color picker or hex input." },
      { step: "Add more pairs", description: "Click \"Add pair\" to test additional color combinations. Label each pair for easy reference." },
      { step: "Check the results", description: "Each row shows the contrast ratio, a live text preview, and the WCAG level (AAA/AA/AA Large/FAIL)." },
      { step: "Export", description: "Download the full report as CSV for documentation or client deliverables." },
    ],
    faq: [
      { question: "What is \"AA Large\"?", answer: "AA Large means the contrast ratio is between 3:1 and 4.5:1. This passes WCAG AA only for large text (18pt+ regular or 14pt+ bold). It fails for normal body text." },
      { question: "What contrast ratio do I need for icons?", answer: "Non-text elements like icons and UI components require a 3:1 contrast ratio (WCAG 1.4.11 Non-text Contrast). This is the same threshold as \"AA Large\" in this tool." },
      { question: "Can I test more than the default pairs?", answer: "Yes. Click \"Add pair\" to test as many combinations as you need. There is no limit." },
    ],
  },
  {
    slug: "webcam-colorblind",
    title: "Webcam Color Blind Simulator",
    shortTitle: "Live Color Blind Sim",
    description: "See the real world through the eyes of color-blind users. Uses your webcam to apply real-time color blindness filters — no upload required.",
    metaDescription: "Free real-time webcam color blind simulator. Apply protanopia, deuteranopia, tritanopia, and achromatopsia filters to your live camera feed. 100% client-side, no data sent.",
    longDescription: "Start your camera and instantly preview how the physical environment, printed materials, or on-screen UI looks to users with various types of color blindness. Supports 7 simulation types. All processing happens locally in your browser — no video is transmitted to any server.",
    icon: Camera,
    category: "simulate",
    keywords: ["webcam color blind simulator", "real-time color blindness", "protanopia simulator", "deuteranopia", "live color blind test"],
    status: "live",
    whyItMatters: "Color blindness affects approximately 8% of men and 0.5% of women. Testing your designs with a live camera lets you evaluate real-world materials (print, signage, presentations) that static image uploads cannot capture.",
    howToUse: [
      { step: "Select a filter", description: "Choose from 7 color blindness types: Protanopia, Deuteranopia, Tritanopia, Achromatopsia, and more." },
      { step: "Click \"Start Camera\"", description: "Grant camera permission when prompted. The live feed appears immediately with the selected filter applied." },
      { step: "Point at your content", description: "Aim your camera at screen designs, printed materials, signage, or any physical content to evaluate it in real time." },
      { step: "Switch filters", description: "Change the filter type without stopping the camera to compare different vision types instantly." },
    ],
    faq: [
      { question: "Is my camera footage sent to your servers?", answer: "No. All processing happens entirely in your browser using the Canvas API. No video data ever leaves your device." },
      { question: "Which browser permissions are required?", answer: "The tool requires camera permission in your browser. Click \"Allow\" when prompted. You can revoke permission at any time through your browser settings." },
      { question: "What is the difference between Protanopia and Deuteranopia?", answer: "Both are types of red-green color blindness. Protanopia (red-blind) makes reds appear very dark. Deuteranopia (green-blind) makes greens appear indistinguishable from reds. Deuteranopia is the most common form, affecting ~6% of males." },
    ],
  },
  {
    slug: "form-error-checker",
    title: "Form Error Accessibility Checker",
    shortTitle: "Form Error Checker",
    description: "Paste your form HTML to check for missing labels, unlinked error messages, missing role=alert, and WCAG 3.3.1 violations.",
    metaDescription: "Free form error accessibility checker. Detects missing aria-describedby links, role=alert, fieldset groups, and WCAG 3.3.1/3.3.2 violations. 100% client-side.",
    ...
    icon: AlertTriangle,
    category: "check",
    keywords: ["form accessibility checker", "aria-describedby", "role alert", "wcag 3.3.1", "form error wcag", "accessible forms"],
    status: "live",
    whyItMatters: "Forms are one of the most common sources of WCAG failures. Error messages that only appear visually — without programmatic links to their input fields — are completely invisible to screen reader users. WCAG 3.3.1 (Level A) requires errors to be identified and described in text.",
    howToUse: [
      { step: "Paste form HTML", description: "Copy your form's HTML and paste it into the text area, or click \"Load problematic example\" to see a demonstration." },
      { step: "Review issues", description: "Errors, warnings, and informational notes appear with specific element selectors and WCAG references." },
      { step: "Apply fixes", description: "Each issue includes a specific code fix. Copy the fix and apply it to your HTML." },
      { step: "Download report", description: "Download a plain-text report for documentation or sharing with developers." },
    ],
    faq: [
      { question: "What does aria-describedby do?", answer: "aria-describedby links an input to a descriptive element (like an error message) by ID. When the input receives focus, screen readers announce both the input's label and the description — making the error audible." },
      { question: "When should I use role=alert vs aria-live?", answer: "Use role=alert (which implies aria-live=\"assertive\") for critical errors that require immediate attention. Use aria-live=\"polite\" for status messages that don't need to interrupt the user. For form validation errors, role=\"alert\" is usually correct." },
      { question: "Does this catch all form accessibility issues?", answer: "No. Static HTML analysis cannot detect JavaScript-driven behavior, CSS-only error states, or timing issues. This tool catches common structural problems. Always test with a real screen reader (NVDA, JAWS, VoiceOver) for complete validation." },
    ],
  },
  {
    slug: "alt-quality-scorer",
    title: "Alt Text Quality Scorer",
    shortTitle: "Alt Quality Scorer",
    description: "Upload an image, enter your existing alt text, and get AI scores on accuracy, informativeness, conciseness, and redundancy — plus an improved version.",
    metaDescription: "Free AI alt text quality scorer. Get scores for accuracy, informativeness, conciseness, and redundancy with an improved alt text suggestion. WCAG 1.1.1. Requires OpenAI API key.",
    longDescription: "Move beyond just generating alt text — evaluate and improve what you already have. Upload any image, paste your current alt text, and receive a detailed score across four WCAG-relevant dimensions with actionable improvement suggestions powered by GPT-4o-mini.",
    icon: Sparkles,
    category: "generate",
    keywords: ["alt text quality checker", "alt text scorer", "wcag 1.1.1", "image alt text evaluation", "ai alt text review"],
    status: "live",
    whyItMatters: "Auto-generated and manually written alt text varies wildly in quality. Too brief and it loses meaning. Too long and it becomes noise. Including 'photo of' or 'image of' wastes valuable context. A quality score gives you objective feedback on what actually matters for WCAG 1.1.1 compliance.",
    howToUse: [
      { step: "Add your OpenAI API key", description: "Your key is used directly from your browser — never sent to our servers." },
      { step: "Upload an image", description: "Drop or select the image whose alt text you want to evaluate." },
      { step: "Enter your alt text", description: "Paste the current alt text and optionally describe the page context." },
      { step: "Review scores", description: "See scores for accuracy, informativeness, conciseness, and redundancy — plus a suggested improvement." },
    ],
    faq: [
      { question: "What model is used for scoring?", answer: "The tool uses OpenAI's GPT-4o-mini, which supports vision (image understanding). It analyzes both the image and your alt text to provide context-aware scoring." },
      { question: "Is my image sent to OpenAI?", answer: "Yes, the image is sent to OpenAI's API as a base64-encoded data URL for analysis. It is not retained or trained on per OpenAI's API terms. Your API key is used directly from your browser." },
      { question: "What makes a perfect alt text score?", answer: "A top score means the alt text accurately describes the image's purpose, provides useful information for non-sighted users, is concise (under 125 characters for most images), and avoids redundant phrases like 'image of' or 'photo of'." },
    ],
  },
  {
    slug: "ai-aria-generator",
    title: "AI ARIA Component Generator",
    shortTitle: "AI ARIA Generator",
    description: "Describe any UI component in plain English and get production-ready accessible code following WAI-ARIA Authoring Practices — with keyboard interactions and full ARIA attributes.",
    metaDescription: "Free AI ARIA component generator. Describe a modal, tabs, accordion, or any component and get accessible HTML, React TSX, or Vue 3 code following WAI-ARIA APG patterns. Requires OpenAI API key.",
    ...
    icon: Sparkles,
    category: "generate",
    keywords: ["aria generator", "accessible component generator", "wai-aria apg", "ai accessibility", "wcag aria patterns", "accessible modal tabs accordion"],
    status: "live",
    whyItMatters: "Implementing ARIA patterns correctly is complex. The WAI-ARIA Authoring Practices Guide defines precise keyboard interactions and ARIA attributes for every common UI pattern, but most developers implement them incorrectly. This tool generates correct implementations automatically, reducing the risk of accessibility bugs.",
    howToUse: [
      { step: "Add your OpenAI API key", description: "Your key is used directly from your browser — never sent to our servers." },
      { step: "Describe your component", description: "Type a plain English description, or select a preset (modal, tabs, accordion, etc.)." },
      { step: "Choose output format", description: "Select HTML, React (TSX), or Vue 3 as your target format." },
      { step: "Generate and copy", description: "Review the generated code and accessibility notes, then copy or download." },
    ],
    faq: [
      { question: "Does the generated code use real ARIA APG patterns?", answer: "Yes. The system prompt instructs GPT-4o-mini to follow WAI-ARIA APG patterns specifically, including keyboard interactions (Arrow keys, Enter, Escape, Space, Tab) appropriate to each component type." },
      { question: "Should I use the generated code directly in production?", answer: "Always review generated code before production use. Test with keyboard navigation and at least one screen reader (NVDA, VoiceOver, JAWS). The AI follows best practices but may occasionally miss edge cases specific to your implementation." },
      { question: "Can I request any component type?", answer: "Yes. Common patterns like modal, tabs, accordion, combobox, breadcrumb, tooltip, progress bar, toggle, and pagination work best. You can also describe custom components — the AI will apply the most appropriate ARIA pattern." },
    ],
  },
];
